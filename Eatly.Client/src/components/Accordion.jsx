  ...
  return (
    ...
    <div className=" bg-transparent  w-full pt-25">
        <div className=" py-16 px-6 md:px-20 max-w-7xl mx-auto flex flex-col items-center relative" >
            ...
            Frequently Asked <br /><span className="text-purple-500">Questions</span>
            </h2>
      ...
      <div className="collapse collapse-plus  custom-collapse border border-b-gray-300 rounded-none">
          <input type="radio" name="faq-accordion" className='text-purple-500' />
          <div className="collapse-title font-medium text-gray-800 text-base">
            How Does It Work ?
          </div>
