...
export default function BlogdetailsContent({ className }) {
  ...
  return (
    <div className="flex flex-col justify-between h-full">
      <section className="">
        <h2 className="md:mb-10  text-xl md:text-3xl font-bold  text-text-darker ">
          Browse Restaurants And Menus
        </h2>
        <p className="text-text-darker leading-10 text-sm md:text-lg pt-5 md:pt-0">
        ...
        <ul className="list-disc list-inside text-text-darker space-y-2 pt-20  text-sm md:text-lg">
          <li>It was popularized in the 1960s with the release</li>
          <li>Lorem Ipsum passages, and more recently</li>
        </ul>
      </section>
      <img
        className="pt-15 pb-15 md:hidden"
        src="https://images.unsplash.com/photo-1742615869881-95b71cee478c?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt=""
      />

      <section>
        <h2 className="text-xl md:text-3xl font-bold  md:mb-10  text-text-darker">
          Select Your Items
        </h2>
        <p className="text-text-darker leading-10  text-sm md:text-lg pt-5 md:pt-0">
