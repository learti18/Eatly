  ...
  return (
    <div className="flex flex-col md:flex-row form-control w-full pt-20 gap-2">
      ...
      >
        ...
        <input
          type="text"
          className="grow text-primary py-1 outline-none bg-transparent placeholder:text-text-lighter"
          placeholder="Apply Coupon"
        />
      </div>
      <button className='md:w-2/5 bg-purple py-4 text-lg text-white rounded-2xl'>Apply</button>
    </div>
  )
}
